...
export function useFormSchema(): VbenFormSchema[] {
  return [
    ...
    {
      fieldName: 'inWarehousingTotalAmount',
      label: '入库物品金额合计',
      component: 'Input',
      componentProps: {
...
/** 列表的字段 */
export function useGridColumns(): VxeTableGridOptions<PurchaseInWarehousingApi.PurchaseInWarehousing>['columns'] {
  return [
    ...
    {
      field: 'inWarehousingDate',
      title: '入库日期',
      minWidth: 120,
      formatter: 'formatDateTime',
    },
    {
      field: 'inWarehousingDesc',
      title: '入库说明',
      minWidth: 120,
    },
    {
      field: 'inWarehousingFile',
      title: '附件',
      minWidth: 120,
    },
    {
      field: 'inWarehousingTotalData',
      title: '采购物品合计',
      minWidth: 120,
    },
    {
      field: 'inWarehousingTotalAmount',
      title: '入库物品金额合计',
      minWidth: 120,
    },
    {
...
/** 新增/修改列表的字段 */
export function useGoodsWarehousingDetailGridEditColumns(): VxeTableGridOptions<PurchaseInWarehousingApi.GoodsWarehousingDetail>['columns'] {
  return [
    {
      field: 'purchaseOrderCode',
      title: '关联采购单编码',
    ...
    {
      field: 'commonOperationId',
      title: '公共操作Id',
      minWidth: 120,
      slots: { default: 'commonOperationId' },
    },
    {
